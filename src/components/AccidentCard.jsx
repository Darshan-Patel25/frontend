...
export default function AccidentCard() {
  ...
  const handleSendAlert = async () => {
    ...
    try {
      const response = await fetch("https://alert-systems.onrender.com/api/send-accident-alert", {
        method: "POST",
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const response = await fetch("https://alert-systems.onrender.com/api/verify", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          cardNumber,
